 ...
 */
export type ArticleDocument<Lang extends string = string> = prismicT.PrismicDocumentWithUID<
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type CreatorDocument<Lang extends string = string> = prismicT.PrismicDocumentWithUID<
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type FeaturedProjectsDocument<Lang extends string = string> = prismicT.PrismicDocumentWithoutUID<
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type TopDocument<Lang extends string = string> = prismicT.PrismicDocumentWithoutUID<
    Simplify<TopDocumentData>,
    'top',
    Lang
>;
/**
 ...
 *
 */
export type TitledTextSliceDefault = prismicT.SharedSliceVariation<
    'default',
    Record<string, never>,
    Simplify<TitledTextSliceDefaultItem>
>;
/**
 ...
 *
 */
export type WorksSliceDefault = prismicT.SharedSliceVariation<
    'default',
    Record<string, never>,
